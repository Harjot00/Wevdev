...
function game_over(){
    for (var i = 0; i < 3;i++){
        if(game_arr[i][0] == game_arr[i][1] && game_arr[i][2] == game_arr[i][1]){
        ...
        else if (game_arr[0][i] == game_arr[1][i] && game_arr[2][i] == game_arr[1][i]){
            document.getElementById('game-over').style.display = 'block';
            document.getElementById('winner').innerText = "You won {document.getElementById('current-player').innerText}";
            document.getElementById('current-player').style.display = 'none';
        }
        else if (game_arr[0][0] == game_arr[1][1] && game_arr[1][1] == game_arr[2][2]){
        ...
        else if (game_arr[0][2] == game_arr[1][1] && game_arr[1][1] == game_arr[2][0]){
            document.getElementById('game-over').style.display = 'block';
            document.getElementById('winner').innerText = "You won {document.getElementById('current-player').innerText}";
            document.getElementById('current-player').style.display = 'none';
        }
